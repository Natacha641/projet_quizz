...
button.addEventListener("click", ()=>{
    ...
    fetch("https://https://quizz.adrardev.fr/api/login_check", {
        method: POST, 
        body : body
    })
})
