...
<body>
    ...
    <main>
        ...
        <span class="se_connecter">|S'inscrire</span>
            ...
            <div class="formContainer">
                ...
                <form action="" method="post" class="form_connexion">
                    ...
                    <div class="user_block">
                        <label for="user" class="user_label">Utilisateur:</label>
                    ...
                    <div class="psw_block">
                        <label for="repeat_password" class="psw_label">repetez le mot de passe :</label>
                        <input type="password" id="repeat_password" name="repeat_password" class="password" placeholder="Retapez votre mot de passe" required>
                    </div>
                    <div>
                        <a href="connexion.php" class="link_inscription">j'ai déja un compte</a>
                    </div>


                    <div class="div_btn_send">
                        <button type="submit" class="btn_send" name="envoyer" id="submit_btn">S'inscrire</button>
                    </div>
