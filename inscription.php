        ...
        <section class="section_formulaire">
            <div class="formContainer">
                ...
                <form action="" method="post" class="form_connexion">
                    ...
                    <div class="psw_block">
                        <label for="password" class="psw_label">repetez le mot de passe :</label>
                        <input type="password" id="repeat_password" name="repeat_password" class="password" placeholder="mot de passe" required>
                    </div>
                    <div>
    ...
    <main>
        ...
        <div class="formContainer">
            <form action="" method="post" class="">
                ...
                <div class="button">
                    <button type="submit" class="BGOrange size12" name="envoyer">Valider l'inscription</button>
                </div>
            </form>
        </div>
    </main>
